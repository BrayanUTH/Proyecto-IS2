<div class="content-header">
    ...
    <div class="card card-secondary">
        <div class="card-header">
            <h3 class="card-title">Registrar Un Convenio de Pago</h3>
        </div>
        <div class="card-body row justify-content-center">
            <div class="col-8" style="background-color: rgba(163, 168, 172, 0.507); padding: 25px; border-radius: 10px;">
                <form name="form_convenio" id="form_convenio" method="POST">
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <input name="" id="" onclick="abrirModalCargo();" class="seleccionar btn btn-outline-info p-1 btn-block" type="button" value="Seleccionar">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        <input name="" id="" onclick="abrirModal();" class="seleccionar btn btn-outline-info p-1 btn-block" type="button" value="Seleccionar">
                                    </div>
                    ...
                    <input type="button" class="btn btn-success px-5" value="Guardar" onclick="guardarConvenio()">
                </form>
            </div>
        </div>
